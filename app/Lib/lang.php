...
$cm_texts['en_US'] = array(
  ...
  'ct.assurances.1'      =>     'Assurance',
  'ct.assurances.pl'     =>     'Assurances',
...
(@NOTIFICATION_URL)',
  ...
  'en.enrollment.verification' => array(
    ...
    VerificationModeEnum::Verified  => 'Verified'
  ),
...
//    MatchStrategyEnum::External   => 'External',
  ...
  'fd.api.cous' =>     'COUs list',
  'fd.api.cous.desc' => 'Grant COU admin priviledges to the selected COUs',
  'fd.api.key' =>     'API Key',
  ...
  'fd.api.identifier.desc' => 'The Identifier type used to map API locator identifiers to CO Person records',
  ...
  'fd.assurance.attr'  =>   'Assurance Attribute',
  'fd.assurance.value' =>   'Assurance Value',
  'fd.assurance.type'  =>   'Assurance Component',
  'fd.bcc' =>         'BCC',
  ...
  'fd.ef.inv.text' =>    'Invitation Text',
  'fd.ef.inv.text.desc' => 'Optional text to display at the top of Invitation view, after the action buttons',
  ...
  'fd.ef.email.vf' => 'Verified Email Attribute',
  ...
  'fd.ef.intro' =>    'Petition Introduction',
  'fd.ef.intro.desc' => 'Optional text to display at the top of a Petition form',
  'fd.ef.invite.intro' =>  'Invitation Introduction',
  'fd.ef.invite.intro.desc' => 'Optional text to display at the top of the Ivitation Acceptance form',
  'fd.ef.progress' => 'Progress Message',
  'fd.ef.progress.desc' => 'Optional text to display during the Enrollment Flow registration process',
  'fd.ef.progress.default' => 'Your enrollment is being processed, please do not refresh or close and click back button on this window.',
  ...
  'fd.ef.skip.tofinalize' => 'Skip to Finalize',
  'fd.ef.skip.tofinalize.desc' => 'The petition will finalize immediately after the creation of the CO Person',
  ...
  'sh.job.no_configuration' => 'No configuration found',
  ...
  'sh.job.provision.now' => '%1$s Model is being provisioned:',
  'sh.job.provision.nothing' => 'Nothing to provision for Model %1$s',
  'sh.job.provision.completed' => 'Provision for Model %1$s completed successfully',
  'sh.job.provision.total' => 'Total successes: %1$s, Total fails: %2$s',
  'sh.job.sync.model.not.supported' => 'Model "%1$s" not supported for Syncing',
