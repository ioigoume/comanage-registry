...
<section class="inner-content">
  <?php
    ...
    $options = array(
      'label' => '<span class="visuallyhidden" style="margin-right: 0.3em">' . _txt('op.search.global') . ':</span>'
    );
              ...
              foreach ($r['CoPerson']['CoPersonRole'] as $role) {
                ...
                $title = !empty($role['title'])
                         ...
                         : $this->Html->tag(
                               'cite',
                               _txt('fd.title.none'),
                                    array('style' => 'margin-right: 0.3em;text-transform: lowercase;'));
            ...
            <?php if(is_array($values) && !is_int($key) && !empty($values)): ?>
              <li class="li-global-search">
                <span class="meta-global-search">
                  ...
                  <div class="field-info" style="margin-right:0.5em"><?php print implode(', ', $values)?></div>
                </span>
              </li>
            <?php endif; ?>
            <?php endforeach; ?>
