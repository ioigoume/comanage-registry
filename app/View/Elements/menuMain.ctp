  ...
  <?php
    ...
    if (!empty($cur_co['Co']['id'])) {
      ...
      if ($permissions['menu']['codepartments']) {
        ...
        $linkContent = '<em class="material-icons" aria-hidden="true">business</em><span class="menuTitle">' . _txt(
            'ct.co_departments.pl'
          ) .
      ...
      if ($permissions['menu']['colists']) {
        ...
        $linkContent = '<em class="material-icons" aria-hidden="true">email</em><span class="menuTitle">' . _txt(
            'ct.co_email_lists.pl'
          ) .
          '</span><span class="mdl-ripple"></span>';
      ...
      if (!empty($menuContent['services'])) {
        ...
        if (count(array_keys($services)) > 1) {
          ...
          $linkContent = '<em class="material-icons" aria-hidden="true">apps</em><span class="menuTitle">' . _txt(
              'ct.co_services.pl'
            ) .
            '</span><span class="mdl-ripple"></span>';
      ...
      if ($permissions['menu']['cojobs']) {
        ...
        $linkContent = '<em class="material-icons" aria-hidden="true">assignment</em><span class="menuTitle">' . _txt(
            'ct.co_jobs.pl'
          ) .
          '</span><span class="mdl-ripple"></span>';
      ...
      if ($permissions['menu']['coconfig']) {
        ...
        $linkContent = '<em class="material-icons" aria-hidden="true">build</em><span class="menuTitle">' . _txt(
            'me.configuration'
          ) .
          '</span><span class="mdl-ripple"></span>';
    ...
    $linkContent = '<em class="material-icons" aria-hidden="true">transfer_within_a_station</em><span class="menuTitle">' . _txt(
        'me.collaborations'
      ) .
      '</span><span class="mdl-ripple"></span>';
