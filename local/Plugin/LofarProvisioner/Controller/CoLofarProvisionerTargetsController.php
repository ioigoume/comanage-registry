...
class CoLofarProvisionerTargetsController extends SPTController {
  // Class name, used by Cake
  public $name = "CoLofarProvisionerTargets";
  ...
  function checkWriteFollowups($reqdata, $curdata = null, $origdata = null) {
    ...
    $this->log(get_class($this)."::{$fn}::reqdata" .print_r($reqdata, true), LOG_DEBUG);
    $this->Flash->set(_txt('rs.updated-a3', array(_txt('ct.co_lofar_provisioner_targets.1'))), array('key' => 'success'));
    return true;
  }
