...
## [3.4.13-rciam] - 2022-03-01

### Fixed
- REST API performance issues by skipping fetching of COU list when not needed
- Normalizations should run at beforeValidate callback

## [3.4.12-rciam] - 2022-02-10

### Changed

- Include MVPA info in response from roles API endpoint
...
- Fix issue with expiration policies when there is another active membership

## [3.4.8-rciam] - 2022-10-10

### Fixed

- Fix entitlements for sub COUs with custom roles (LDAP Provisioner)
...
- Support for CO Department types

### Fixed

- Don't show approve/deny option to users without the permission

## [3.4.5-rciam] - 2022-04-20

### Fixed

- Fix Resend Verification Mail functionality
- Don't set mail to unverified when logging into COmanage
...
- CO Population search pagination
...
- Support Syncing for Assurance, Cert And OrgIdentity Model from Job Shell
...
- Fix bug in Population search for users with expired COU membership
...
- Add missing class LdapQueryConstructor

## [3.3.9-rciam] - 2021-12-09
